...
function MenuLateral() {
    ...
    return (
        <div>
            ...
            <nav className={`bg-blue-500 w-1/4 h-screen absolute top-0 p-2 transition-all ease-out transform ${ visivel ? "translate-x-0 shadow-black shadow-xl" : "-translate-x-full"}`}>
                <ul>
